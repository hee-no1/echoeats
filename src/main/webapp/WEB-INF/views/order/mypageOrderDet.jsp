                ...
                '<div class="css-j0lifa ed9qr673"><div class="css-fhxb3m ed9qr672">'+
                    ...
                    // 배송완료 후 정보        
                            ...
                            '<div class="css-1bsokvi e1jm6dy15"><h3 class="css-yi2ox5 e1jm6dy14">결제정보</h3></div>'+
                                '<ul class="css-ny80ny e1sh1vdm3"><li class="css-1rwh8y3 e1ysbs754">'+
                                '<span class="css-11h8hn9 e1ysbs753">상품금액</span>'+
                                '<span class="css-l5tyq9 e1ysbs751">${ordDto.tot_prod_price-ordDto.tot_prod_disc}<span class="css-cvbrkf e1ysbs750">원</span></span></li><li class="css-1rwh8y3 e1ysbs754">'+
                                '<span class="css-11h8hn9 e1ysbs753">상품할인금액</span><span class="css-l5tyq9 e1ysbs751">-${ordDto.tot_prod_disc}<span class="css-cvbrkf e1ysbs750">원</span></span></li><li class="css-1rwh8y3 e1ysbs754">'+
                                '<span class="css-11h8hn9 e1ysbs753">배송비</span><span class="css-l5tyq9 e1ysbs751">${ordDto.dlvy_fee}<span class="css-cvbrkf e1ysbs750">원</span></span></li><li class="css-1rwh8y3 e1ysbs754">'+
                                '<span class="css-11h8hn9 e1ysbs753">쿠폰할인</span><span class="css-l5tyq9 e1ysbs751">-${ordDto.coupon_disc}<span class="css-cvbrkf e1ysbs750">원</span></span></li><li class="css-1rwh8y3 e1ysbs754">'+
                                // '<span class="css-11h8hn9 e1ysbs753">카드즉시할인</span><span class="css-l5tyq9 e1ysbs751">0<span class="css-cvbrkf e1ysbs750">원</span></span></li>'+
                                ...
                                // '<div><svg width="16" height="20" viewBox="0 0 16 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M1 5H0V10V11H1H6V10H1V5Z" fill="#ddd"></path></svg><span>컬리캐시</span></div><span>0<span class="css-cvbrkf e1ysbs750">원</span></span></li></div><li class="css-1rwh8y3 e1ysbs754">'+
                                '<span class="css-11h8hn9 e1ysbs753">적립금</span><span class="css-l5tyq9 e1ysbs751">-${ordDto.point_used}<span class="css-cvbrkf e1ysbs750">원</span></span></li><li class="css-1rwh8y3 e1ysbs754">'+
                                '<span class="css-11h8hn9 e1ysbs753">결제금액</span><span class="css-l5tyq9 e1ysbs751">${ordDto.tot_pay_price}<span class="css-cvbrkf e1ysbs750">원</span></span></li><li class="css-1rwh8y3 e1ysbs754">'+
                                '<span class="css-11h8hn9 e1ysbs753">적립금액</span><span class="css-6779rn e1sh1vdm1">배송완료 7일후 적립</span><span class="css-l5tyq9 e1ysbs751">${ordDto.point_used}<span class="css-cvbrkf e1ysbs750">원</span></span></li><li class="css-1rwh8y3 e1ysbs754">'+
                                '<span class="css-11h8hn9 e1ysbs753">결제방법</span>'+
                                '<div class="css-1r21krv e1sh1vdm2">${ordDto.pay_way}</div></li></ul>'+
                            '<div class="css-1bsokvi e1jm6dy15"><h3 class="css-yi2ox5 e1jm6dy14">주문정보</h3></div><ul class="css-17f5yp3 eu7fh4o3"><li class="css-16lrjcx eu7fh4o2">'+
                                '<span class="css-19msp73 eu7fh4o1">주문번호</span><span class="css-2wk6tm eu7fh4o0">${ordDto.ord_id}</span></li><li class="css-16lrjcx eu7fh4o2">'+
                                '<span class="css-19msp73 eu7fh4o1">보내는 분</span><span class="css-2wk6tm eu7fh4o0">${mem_id}</span></li><li class="css-16lrjcx eu7fh4o2">'+
                                '<span class="css-19msp73 eu7fh4o1">결제일시</span><span class="css-2wk6tm eu7fh4o0">'+
                                    '<fmt:formatDate value="${ordDto.ord_date}" pattern="yyyy-MM-dd HH:mm:ss" type="date"/></span></li></ul>'+
                            '<div class="css-1bsokvi e1jm6dy15"><h3 class="css-yi2ox5 e1jm6dy14">배송정보</h3></div><ul class="css-17f5yp3 eu7fh4o3"><li class="css-16lrjcx eu7fh4o2">'+
                                '<span class="css-19msp73 eu7fh4o1">받는분</span><span class="css-2wk6tm eu7fh4o0">김경훈</span></li><li class="css-16lrjcx eu7fh4o2">'+
                                '<span class="css-19msp73 eu7fh4o1">핸드폰</span><span class="css-2wk6tm eu7fh4o0">010-9919-****</span></li><li class="css-16lrjcx eu7fh4o2">'+
                                '<span class="css-19msp73 eu7fh4o1">주소</span><span class="css-2wk6tm eu7fh4o0">(03164) 서울 종로구 종로 69 (서울 YMCA) 5층 522호</span></li><li class="css-16lrjcx eu7fh4o2">'+
                                '<span class="css-19msp73 eu7fh4o1">받으실 장소</span><span class="css-2wk6tm eu7fh4o0">문 앞</span></li><li class="css-16lrjcx eu7fh4o2">'+
                                '<span class="css-19msp73 eu7fh4o1">공동현관 출입방법</span><span class="css-2wk6tm eu7fh4o0">자유 출입 가능</span></li><li class="css-16lrjcx eu7fh4o2">'+
                                '<span class="css-19msp73 eu7fh4o1">포장 방법</span><span class="css-2wk6tm eu7fh4o0">종이 포장재</span></li></ul>'
